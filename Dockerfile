...
RUN a2enmod  rewrite
RUN wget https://raw.githubusercontent.com/theoddcompanyceo/railway/main/000-default.conf
RUN rm /etc/apache2/sites-available/000-default.conf
RUN mv 000-default.conf /etc/apache2/sites-available
RUN echo 'You can ssh into this vps now! - Message from The Odd Company!' >/var/www/html/index.html
